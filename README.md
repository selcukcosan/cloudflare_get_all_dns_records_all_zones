This Python script gets all zones and writes the DNS Records into json files for ALL zones the specified Cloudflare account. You need to get Beearer Token ID to retrieve the records.
